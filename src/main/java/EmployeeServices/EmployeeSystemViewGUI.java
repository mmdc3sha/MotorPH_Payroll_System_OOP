...
public class EmployeeSystemViewGUI extends EmployeeServices {
    ...
    private static JPanel leavesPanel;
    ...
    private static JTextField empID_LoadRequest;
    private static DefaultTableModel leaveModel;
    private static JTable leaveTable;
    private static JScrollPane leaveScrollPane;
